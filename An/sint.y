...
%type <NoTerminal> DESMONTAR  PARAMETROS_REPORTES  P_FDISK REPORTES INICIO OPCIONES_FIT MONTAR CADENA_O_ID  MENU_COMANDOS CREAR_DISCO TAM ELIMINAR_DISCO PARAMETROS_MKDISK P_MKDISK ADMINISTRAR_PARTICIONES TAM2 TYPE_PARTICION OPCIONES_DELETE P_REPORTE
